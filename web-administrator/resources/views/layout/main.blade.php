      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" style="padding-bottom:10%" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{route('managerReport')}}" class="nav-link {{ request()->routeIs('managerReport') ? 'active' : '' }}">
            ...
            <li class="nav-item">
              <a href="{{route('tsReport')}}" class="nav-link {{ request()->routeIs('tsReport') ? 'active' : '' }}">
                <i class="nav-icon fas fa-chart-line"></i>
                <p>
                  Report
                </p>
